 ...
 * helper methods.
 */
public class WifiAndBleService extends IntentService {
    ...
    private int device;
    private char head;
    public WifiAndBleService() {
        super("WifiAndBleService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (scanMode==0) {
            ...
            MainActivity.mainActivity.scan.startBleAndWifiStaScan(dur,device,head,x,y,z);
        }
        //动态扫描
        if(scanMode == 1){
            device = intent.getIntExtra("device",0);
            ...
            y = intent.getFloatExtra("y",0);
            z = intent.getFloatExtra("z",0);
            SecondActivity.secondActivity.scan.startDynWifiBleScan(device,head,x,y,z);
        }
    }
